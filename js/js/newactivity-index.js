    ...
    '<span class="close-suspension"><img src="images/suspension-close.png"></span>' +
           '<div  class="fr">   <!--p class="p-num">今天已有 <span id="visitornum">573</span> 人成功获取礼品方案</p-->  <form action=""><div class="divselect" class="hover"><cite>礼品用途</cite>'+
                       ...
                       '<ul class="content mCustomScrollbar" id="industrytype"> '+
                           '<li><a value="1">银行保险</a></li><li><a value="2">金融证券</a></li><li><a value="3">房地产</a></li><li><a value="4">企事业单位</a></li> <li><a value="5">综合集团</a></li> <li><a value="6">教育培训</a></li> <li><a value="7">汽车</a></li> <li><a value="8">航空航天</a></li> <li><a value="9">医药卫生</a></li> <li><a value="10">互联网IT</a></li> <li><a value="11">通讯信息</a></li> <li><a value="12">旅游</a></li> <li><a value="13">美容</a></li> <li><a value="14">酒店餐饮</a></li> <li><a value="15">出口贸易</a></li> <li><a value="16">文化娱乐</a></li> <li><a value="17">礼品商</a></li> <li><a value="18">服务</a></li> <li><a value="19">其他</a></li>' +
                       '</ul><div class="big-bg"></div></div> '+
                  '<div class="divselect" class="hover"><cite>礼品品类</cite><p>请选择</p><ul class="content mCustomScrollbar" id="giftfeature"> <li><a value="1">高端商务</a></li> <li><a value="2">免费赠送</a></li> <li><a value="3">创意实用</a></li> <li><a value="4">数码科技</a></li> <li><a value="5">家居生活</a></li><li><a value="6">最热门</a></li> <li><a value="7">高溢价</a></li><li><a value="8">其他</a></li></ul><div class="big-bg"></div></div> ' +
                  '<div class="divselect" class="hover"><cite>定制数量</cite><p>请选择</p><ul class="content mCustomScrollbar" id="clientnumber"> <li><a value="1">50件以内</a></li> <li><a value="2">50 ~ 100件</a></li> <li><a value="3">100 ~ 500件</a></li> <li><a value="4">500 ~ 1000件</a></li> <li><a value="5">1000 ~ 5000件</a></li> <li><a value="6">5000 ~ 10000件</a></li> <li><a value="7">10000件以上</a></li></ul><div class="big-bg"></div></div> ' +
                   '<div class="divselect" class="hover"><cite>单位预算</cite><p>请选择</p><ul class="content mCustomScrollbar" id="budget"> <li><a value="1">1万以内</a></li> <li><a value="2">1万 ~ 5万</a></li> <li><a value="3">5万 ~ 10万</a></li> <li><a value="4">10万 ~ 100万</a></li> <li><a value="5">100万以上</a></li></ul><div class="big-bg"></div></div> ' +
