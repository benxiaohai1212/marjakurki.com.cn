(function($){
	$.fn.changeImg=function(options){
		...
		var _html='<a href="javascript:;" class="change-bnt prev-bnt"><i class="fa fa-angle-left fa-3x"></i></a><a href="javascript:;" class="change-bnt next-bnt"><i class="fa fa-angle-right fa-3x"></i></a>';
